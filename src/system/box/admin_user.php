...
<div class="modal_wrap_top pro_top  profile_background <?php echo coverClass($user); ?>" <?php echo getCover($user); ?>>
	...
	<div class="cover_text centered_element bpad15">
		...
		<?php if(!empty($music) && canDeleteProfileMusic($user)){ ?>
		<div id="staff_pmusic" class="pdetails tpad5">
			<div id="del_pmusic" onclick="adminRemoveProfileMusic(<?php echo $user['user_id']; ?>);" class="lite_olay proplayer_btn">
